...
| **P1 — Foundations** | Local compose (api, content-db, identity-db, mailpit), migrations for both DBs, identity DB + author auth (password/passkey, optional magic link) | An author can log in locally |
